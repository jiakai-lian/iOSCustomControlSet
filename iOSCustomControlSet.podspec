...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/iOSCustomControlSet"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "jiakailian" => "jiakai.lian@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/iOSCustomControlSet.git", :tag => s.version.to_s }
